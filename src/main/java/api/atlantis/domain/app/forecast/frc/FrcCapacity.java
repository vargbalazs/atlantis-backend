...
@SqlResultSetMapping(
        name = "FrcCapacityPerCapGroupMapping",
        classes = @ConstructorResult(
                targetClass = FrcCapacityPerCapGroup.class,
                columns = {
...
@Entity
public class FrcCapacity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_frc_capacity")
    @SequenceGenerator(name = "seq_frc_capacity", allocationSize = 1)
    ...
    public FrcCapacity(Long id, Frc frc, CapGroup capGroup, int p1, int p2, int p3, int p4, int p5, int p6, int p7,
                       int p8, int p9, int p10, int p11, int p12) {
        this.id = id;
        this.frc = frc;
