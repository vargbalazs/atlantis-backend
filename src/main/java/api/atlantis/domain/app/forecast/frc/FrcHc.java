...
@SqlResultSetMapping(
        name = "FrcHcPerDepartmentMapping",
        classes = @ConstructorResult(
                targetClass = FrcHcPerDepartment.class,
                columns = {
                        @ColumnResult(name = "hcPlanningItemId", type = Long.class),
                        @ColumnResult(name = "department", type = String.class),
                        @ColumnResult(name = "costGroup", type = String.class),
...
public class FrcHc {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_frc_hc")
    @SequenceGenerator(name = "seq_frc_hc", allocationSize = 1)
    ...
    public FrcHc(Long id, Frc frc, HcPlanningItem hcPlanningItem, int p1, int p2, int p3, int p4, int p5, int p6,
