...
public class FrcCapacityPerCapGroup {
    ...
    public FrcCapacityPerCapGroup() {
    }

    public FrcCapacityPerCapGroup(Long capGroupId, String capGroup, String capName, String capType, String unit, Long id,
                                  Long frcId, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9,
