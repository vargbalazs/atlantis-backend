...
public class ActualCapacityPerCapGroup {
    ...
    public ActualCapacityPerCapGroup() {
    }

    public ActualCapacityPerCapGroup(Long capGroupId, String capGroup, String capName, String capType, int year,
                                     Long plantId, Long companyId, String unit, Long id, int p1, int p2, int p3, int p4,
